...
- **Big Vision Productions (BVP)** — Portland OR + "Level 9 Afters" Orlando FL
  - Contact: hiatusevents@gmail.com (Tyler — the referral source, not BVP's own domain)
  - Referred by: Tyler from Hiatus Events (hiatusevents@gmail.com) — known referral, not unknown entity
  - Context note (2026-04-28): Thomas confirmed BVP came through Tyler. The Gmail address is Tyler's contact, not a BVP red flag. Treat as C (new/unknown, insufficient data) pending full research — NOT as D/F.
  - Venue: NOVA PDX (722 E Burnside St, Portland OR 97214) — active events confirmed Feb/Mar/Apr 2026
  - Status: Active, legitimate referral. Full grade pending promoter research subagent output.
